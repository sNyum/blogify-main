...
<nav id="navbar" class="bg-white/70 backdrop-blur-xl fixed w-full z-50 border-b border-gray-200/50 shadow-lg shadow-blue-500/5 transition-all duration-500 ease-out">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div id="nav-content" class="flex justify-between h-20 transition-all duration-500">
            ...
            <div class="hidden sm:flex sm:items-center sm:gap-8">
                <a href="/modul-sektoral" class="nav-link relative text-sm font-medium {{ request()->is('modul-sektoral*') ? 'text-blue-600 font-bold' : 'text-gray-700' }} hover:text-blue-600 transition-all duration-300 group">
                    Modul Sektoral
                    <span class="absolute -bottom-1 left-0 {{ request()->is('modul-sektoral*') ? 'w-full' : 'w-0' }} h-0.5 bg-gradient-to-r from-blue-600 to-blue-400 group-hover:w-full transition-all duration-300"></span>
                </a>
                <a href="/berita" class="nav-link relative text-sm font-medium {{ request()->is('berita*') ? 'text-blue-600 font-bold' : 'text-gray-700' }} hover:text-blue-600 transition-all duration-300 group">
                    Berita
                    <span class="absolute -bottom-1 left-0 {{ request()->is('berita*') ? 'w-full' : 'w-0' }} h-0.5 bg-gradient-to-r from-blue-600 to-blue-400 group-hover:w-full transition-all duration-300"></span>
                </a>
                <a href="/pustaka" class="nav-link relative text-sm font-medium {{ request()->is('pustaka*') ? 'text-blue-600 font-bold' : 'text-gray-700' }} hover:text-blue-600 transition-all duration-300 group">
                    Pustaka
                    <span class="absolute -bottom-1 left-0 {{ request()->is('pustaka*') ? 'w-full' : 'w-0' }} h-0.5 bg-gradient-to-r from-blue-600 to-blue-400 group-hover:w-full transition-all duration-300"></span>
                </a>
    ...
    <div id="mobile-menu" class="hidden sm:hidden bg-white/95 backdrop-blur-xl border-t border-gray-200">
        <div class="px-4 pt-2 pb-3 space-y-1">
            <a href="/modul-sektoral" class="block px-3 py-2 rounded-lg text-base font-medium {{ request()->is('modul-sektoral*') ? 'text-blue-600 bg-blue-50 font-bold' : 'text-gray-700' }} hover:text-blue-600 hover:bg-blue-50 transition-all duration-300">Modul Sektoral</a>
            <a href="/berita" class="block px-3 py-2 rounded-lg text-base font-medium {{ request()->is('berita*') ? 'text-blue-600 bg-blue-50 font-bold' : 'text-gray-700' }} hover:text-blue-600 hover:bg-blue-50 transition-all duration-300">Berita</a>
            <a href="/pustaka" class="block px-3 py-2 rounded-lg text-base font-medium {{ request()->is('pustaka*') ? 'text-blue-600 bg-blue-50 font-bold' : 'text-gray-700' }} hover:text-blue-600 hover:bg-blue-50 transition-all duration-300">Pustaka</a>
