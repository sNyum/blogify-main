...
@section('content')
    ...
    <!-- Breadcrumb & Back -->
    <div class="mb-6">
        <a href="{{ route('bps.pembinaan.index') }}" class="inline-flex items-center text-gray-500 hover:text-[#F15A24] font-medium mb-4">
        ...
        <div class="bg-orange-50 rounded-lg overflow-hidden shadow-sm transition-all duration-300">
            ...
            <div x-show="activeTab === '{{ $key }}'" x-collapse x-cloak class="px-6 py-4 bg-white border-t border-orange-100">
                ...
                <div class="mb-4 bg-white p-4 rounded-lg border border-orange-100 shadow-sm">
                    ...
                    <form action="{{ route('bps.pembinaan.store', $opd->id) }}" method="POST" enctype="multipart/form-data" class="flex gap-2 items-start">
                        @csrf
