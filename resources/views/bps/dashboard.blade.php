...
@section('content')
    ...
    <div class="bg-gradient-to-r from-green-600 to-green-500 rounded-2xl shadow-lg p-8 mb-8 text-white relative overflow-hidden">
        <div class="relative z-10">
            <h1 class="text-3xl font-bold mb-2">Selamat Datang, {{ $staff->name }}!</h1>
            <p class="text-green-100 text-lg">Bidang Integrasi Pengolahan dan Diseminasi Statistik</p>
            <p class="text-green-100 text-sm mt-4 opacity-80">Siap bekerja untuk statistik berkualitas?</p>
        </div>
        <!-- Decorative Circle -->
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <!-- Card 2: Pending Registrations (Mungkin staff tidak perlu tahu ini? Tapi biar sama kaya OPD) -->
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-orange-500 font-semibold mt-2">Daftar Baru</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
            <h3 class="font-bold text-gray-800 text-lg">OPD Binaan Terbaru</h3>
            <a href="#" class="text-sm text-[#F15A24] font-semibold hover:underline">Lihat Semua</a>
        </div>
